...
describe('UserService', () => {
    ...
    describe('getAllUser', () => {
        it('should be success', async () => {
            ...
            expect(result).toEqual(mockUsersData.map((item) => {
                return { ...item, createdAt: undefined, updatedAt: undefined, password: undefined }
            }))
        })
    ...
    describe('getUserInfo', () => {
        it('should be success', async () => {
            ...
            expect(result).toEqual({ ...mockUserData, createdAt: undefined, updatedAt: undefined, password: undefined })
        })
    ...
    describe('findByUsername', () => {
        ...
        it('should be throw error User not found', async () => {
            UserRepository.prototype.findOne = jest.fn()
            await expect(userService.findByUsername('test')).rejects.toThrow('User not found')
