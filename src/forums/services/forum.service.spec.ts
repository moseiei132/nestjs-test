...
describe('ForumService', ()=>{
    ...
    describe('getForums', ()=>{
        it('should be success', async () => {
            ...
            expect(result).toEqual(mockForumsData.map((item)=>{
    ...
    describe('getForum', ()=>{
        it('should be success', async () => {
            ...
            ForumRepository.prototype.findOne = jest.fn().mockReturnValue(mockForumData)
            const result = await forumService.getForum(1)
            expect(result).toEqual({...mockForumData, createdAt: undefined, updatedAt: undefined})
        })
        it('should be throw error not found', async () => {
    ...
    describe('createForum', ()=>{
        it('should be success', async () => {
            ...
            const result = await forumService.createForum({name:'test', description: 'test'})
